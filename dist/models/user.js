...
var UserModel = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = "INSERT INTO users (firstName, LastName, userName, password) VALUES($1, $2, $3, $4) RETURNING id, userName, firstName, lastName";
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = "DELETE FROM users WHERE id=($1) RETURNING id, userName, firstName, lastName";
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [id])];
    ...
    UserModel.prototype.update = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, hash, result, user, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = "UPDATE users SET userName=($2), firstName=($3), lastName=($4), password=($5)  WHERE id=($1) RETURNING id, userName, firstName, lastName";
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
                        hash = bcrypt_1["default"].hashSync(u.password + pepper, parseInt(saltRounds));
                        return [4 /*yield*/, conn.query(sql, [u.id, u.userName, u.firstName, u.lastName, hash])];
                    case 2:
                        result = _a.sent();
                        user = result.rows[0];
                        conn.release();
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Could not update User ".concat(u.id, ". Error: ").concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
