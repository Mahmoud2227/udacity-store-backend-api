...
var storeOrder = new order_1.OrderModel();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, storeOrder.create(order)];
            case 1:
                newOrder = _a.sent();
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, status_1, id, newOrder, err_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, status_1 = _a.status, id = _a.id;
                return [4 /*yield*/, storeOrder.update(id, status_1)];
            case 1:
                newOrder = _b.sent();
                return [2 /*return*/, res.send(newOrder)];
            case 2:
                err_4 = _b.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.body.id;
                return [4 /*yield*/, storeOrder["delete"](id)];
            case 1:
                order = _a.sent();
...
var addProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, storeOrder.addProduct(quantity, orderId, productId)];
            case 2:
                addedProduct = _a.sent();
                return [2 /*return*/, res.send(addedProduct)];
            case 3:
                err_6 = _a.sent();
                console.log(err_6);
                res.status(400);
