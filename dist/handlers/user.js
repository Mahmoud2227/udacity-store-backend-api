...
var storeUser = new user_1.UserModel();
var index = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var users_1, err_1, users;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                users_1 = _a.sent();
                return [2 /*return*/, res.send(users_1)];
            case 2:
                err_1 = _a.sent();
                console.log(err_1);
                res.status(401).json(err_1);
                return [3 /*break*/, 3];
            case 3: return [4 /*yield*/, storeUser.index()];
            case 4:
                users = _a.sent();
                res.json(users);
                return [2 /*return*/];
...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, storeUser.show(+req.params.id)];
            case 1:
                user = _a.sent();
...
var destroy = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, storeUser["delete"](req.body.id)];
            case 1:
                deleted = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, storeUser.update(user)];
            case 1:
                updated = _a.sent();
